...
export function DefinitionsView({
  ...
  hoveredCategory?: string | null
  onSelect?: (point: AgiPoint, source: { url: string; title: string | null; type: string | null } | null) => void
  searchQuery?: string
  ...
  return (
    <div style={{ padding: '8px 16px' }}>
      ...
      {viewMode === 'scatter' && (
        <ScatterView data={data} colorMode={cm} hoveredCategory={hoveredCategory ?? null} onSelect={handleSelect} />
      )}
