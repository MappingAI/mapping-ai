    ...
    >
      <div className="bg-white rounded-xl px-8 py-7 max-w-[520px] w-[92%] shadow-2xl font-serif">
        ...
        <p className="text-[15px] leading-relaxed text-[#1a1a1a] mb-4">
          Your contribution helps build a comprehensive resource for understanding the AI policy
          landscape.
        </p>
        <div className="space-y-3 mb-5">
          <div className="text-[14px] leading-relaxed">
            <strong>Review:</strong> All submissions are manually reviewed by our team before
            appearing on the map.
          </div>
          <div className="text-[14px] leading-relaxed">
            <strong>Enrichment:</strong> We use AI-assisted research to verify and expand entries
            with additional context, affiliations, and public statements.
          </div>
          <div className="text-[14px] leading-relaxed">
            <strong>Belief Scores:</strong> Stance, timeline, and risk assessments are weighted
            averages. Self-submissions carry more weight than external observations.
          </div>
          <div className="text-[14px] leading-relaxed">
            <strong>Privacy:</strong> We only include publicly available information. You can
            request changes or removal anytime.
          </div>
        </div>
        <p className="text-[13px] leading-relaxed text-[#555] mb-5 p-3 bg-[#f5f5f5] rounded-md">
          ...
          as well as adding new features and improving the UX. Please email us at{' '}
