  ...
  return (
    <FadeIn>
      <div className="border-l-[1.5px] border-border pl-4 mb-[1.4rem]">
        <div className="font-serif text-[16px] font-medium mb-[0.3rem] text-text-primary">
          {title}
        </div>
      ...
      <div className="max-w-[680px] mx-auto px-4 pt-[calc(2.5rem+48px)] pb-12 font-serif text-text-primary text-[17px] leading-[1.75]">
        ...
        <FadeIn>
          <p className="mb-[1.1rem] text-[16.5px]">
            AI represents a step change that demands a renegotiation between government, industry,
            and the public. In short, a new social contract. But the conversation today is stuck in
            old paradigms: the US vs. China, accelerationism vs. safety, regulation vs. laissez
            faire. None of these address the fundamental question: on what terms is the value of
            American technological innovation secured for the public?
          </p>
        </FadeIn>
        <FadeIn>
          <p className="mb-[1.1rem] text-[16.5px]">
            The historical record offers a clear model: when a revolutionary technology arrives,
            societies that build new institutions to meet the moment are able to distribute that
            technology&rsquo;s benefits broadly. Consider American electrification. By 1935, forty
            years after the construction of the first power plants, 90% of urban homes had power,
            but only 10% of rural ones did. Rather than subsidize private utilities or wait for the
            markets to adapt, FDR and the New Deal coalition created the Rural Electrification
            Administration, Tennessee Valley Authority, and community-owned financing structures. By
            1950, the rural/urban electricity gap had closed.
          </p>
        </FadeIn>
        <FadeIn>
          <p className="mb-[1.1rem] text-[16.5px]">
            Our existing institutions were not designed to handle the AI transition. The question
            is: can we build the new institutions we desperately need?
          </p>
        </FadeIn>
        <FadeIn>
          <p className="mb-[1.1rem] text-[16.5px]">
            Crucially, AI is different from electricity. Its adoption is faster than any other
            technology in history. Its risks are existential. And it&rsquo;s owned by a handful of
            firms, controlling not just a market or an infrastructure, but the frontier of knowledge
            production itself. These companies built their products upon decades of publicly funded
            research, open-source infrastructure, human-generated data, and combined ingenuity, yet
            have misaligned incentives to return value to the public&mdash;and face no real
            consequences if something goes terribly wrong. There is no compact governing this
            relationship. Our shared inheritance depends on forging a new one.
          </p>
        </FadeIn>
        ...
        <FadeIn>
          <div className="grid grid-cols-1 gap-3 my-5">
            ...
            <LandscapeBox
              ...
              links={[
                {
                  text: '\u2197 Aschenbrenner, "Situational Awareness"',
        ...
        <FadeIn>
          <p className="mb-[1.1rem] text-[16.5px]">
            People First: AI for the public, building from how innovation is financed, how
            infrastructure is constructed, and how knowledge is maintained. The emphasis is on
            ensuring gains for the public by design, rather than downstream redistribution alone.
            Bringing together labor, safety, national security, and institutional design, our aim is
            to proactively ensure that the American public captures the value of American
            innovation. The overarching mandate is to secure public return.
          </p>
        </FadeIn>
        ...
        <ApproachBlock
          ...
          items={[
            ...
            {
              label: 'Steering',
              text: 'regulation with an affirmative mandate to build, not just bind.',
            },
          ]}
        />
        <ApproachBlock
          ...
          items={[
            {
              label: 'Ownership',
              text: 'distributive ownership structures where the users own the infrastructure.',
            },
            {
              label: 'Commons',
              text: 'shared resources are treated as public property from the start.',
            },
            {
              label: 'Financing',
              text: "capital instruments that don't require monopolistic scale to be worthwhile.",
            },
          ]}
        ...
        <ApproachBlock
          ...
          items={[
            ...
            {
              label: 'Staffed',
              text: 'personnel with technical expertise, including from industry.',
            },
        ...
        <FadeIn>
          <div className="my-5 flex flex-col">
            <TimelineStep time="Now—Apr 2026">
              ...
              , working draft, team assembly. Begin outreach to first-ring contacts. This is where
              we are.
            </TimelineStep>
            <TimelineStep time="May – Aug 2026">
              Expert review workshops validate the framework and convert reviewers into endorsers.
              Domain experts co-author or formally consult on each section. Industry participants
              see a positive-sum case for engagement, not a compliance burden.
            </TimelineStep>
            <TimelineStep time="Late 2026—Midterms">
              Launch endorsed framework with co-signatories spanning academia, former officials,
              industry, labor, and civil society. Set the intellectual terms of the debate before
              the incumbent frames harden into the default.
            </TimelineStep>
            <TimelineStep time="Early 2027">
              Congressional champion introduces legislation in the 120th Congress, making the
              framework a live vehicle that 2028 candidates must engage with.
            </TimelineStep>
            <TimelineStep time="2028 Primary">
              Presidential candidates adopt elements of the framework. AI governance becomes a
              defining issue on kitchen-table terms&mdash;who benefits from American
              innovation&mdash;not elite policy discourse.
            </TimelineStep>
            <TimelineStep time="2029—Day one" isLast>
              A new administration has a specific, staffed technology-society compact ready to
              implement. New institutions are not drafted&mdash;they are ready to build.
            </TimelineStep>
          </div>
        </FadeIn>
