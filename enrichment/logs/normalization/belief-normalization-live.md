# Belief Field Normalization — LIVE RUN
*2026-04-11 02:46 UTC*
...
#### `Ill-defined concept` → `Ill-defined`: **2**
- Entity IDs: 35, 95

### `belief_evidence_source`

#### `Inferred from actions` → `Inferred`: **94**
- Entity IDs: 63, 126, 130, 134, 143, 144, 151, 157, 164, 170, 172, 175, 180, 182, 189, 193, 194, 196, 198, 201, 214, 216, 227, 241, 243, 255, 258, 259, 260, 263, 264, 266, 269, 276, 281, 283, 289, 300, 303, 305, 306, 312, 313, 318, 319, 320, 321, 324, 330, 333, 335, 337, 338, 339, 340, 346, 349, 354, 355, 357, 363, 364, 366, 369, 371, 373, 374, 375, 378, 379, 391, 393, 395, 396, 399, 400, 402, 403, 406, 411, 413, 414, 416, 417, 419, 421, 423, 424, 427, 434, 435, 438, 440, 441

#### `Public statements` → `Explicitly stated`: **5**
- Entity IDs: 708, 709, 712, 721, 722

#### `Inferred from associations` → `Inferred`: **3**
- Entity IDs: 156, 208, 298

#### `Policy proposals` → `Explicitly stated`: **3**
- Entity IDs: 713, 714, 723

#### `Public statements, Campaign messaging` → `Explicitly stated`: **1**
- Entity IDs: 715

#### `Campaign backing and endorsements` → `Inferred`: **1**
- Entity IDs: 720

#### `Super PAC spending, Campaign positions, Organization endorsements` → `Inferred`: **1**
- Entity IDs: 724

#### `Super PAC mission statement and candidate support patterns` → `Inferred`: **1**
- Entity IDs: 711

#### `FEC filings, candidate support patterns, stated mission` → `Inferred`: **1**
- Entity IDs: 710

#### `Campaign backing, Super PAC support` → `Inferred`: **1**
- Entity IDs: 719

**Total entities updated:** 113

## Post-Normalization Distributions
