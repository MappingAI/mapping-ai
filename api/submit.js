    ...
    try {
      ...
      const result = await client.query(
        ...
        [
          ...
          // Resources Rethink Phase 1 — multi-tag + advocated beliefs + source.
          // Arrays default to [] so the column is never NULL from this path.
          // `source` is intentionally accepted here; admins can set it on
          // sister-map resources they create manually before contributor submit.
          Array.isArray(data.topicTags) ? data.topicTags : [],
          Array.isArray(data.formatTags) ? data.formatTags : [],
