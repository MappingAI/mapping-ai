...
- **Not AI-relevant**: Companies that merely _use_ AI rather than shape AI policy
...
```json
{
  ...
  "notes_sources": ["https://arxiv.org/abs/2402.08797"],
  "thumbnail_url": null,
  "belief_regulatory_stance": "Moderate",
...
- NO: Companies that merely _use_ AI (e.g., a retailer using AI recommendations)
