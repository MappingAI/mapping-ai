...
const TIME100_PEOPLE = [
  ...
  {
    name: 'Allie K. Miller',
    title: 'CEO, Open Machine',
    primary_org: 'Open Machine',
    category: 'Executive',
  },
  {
    name: 'Strive Masiyiwa',
    title: 'Founder and Executive Chairman, Cassava Technologies',
    primary_org: 'Cassava Technologies',
    category: 'Executive',
  },
  {
    name: 'Cristiano Amon',
  ...
  {
    name: 'Nat Friedman',
    title: 'Investor and Co-founder, AI Grant',
    primary_org: 'AI Grant',
    category: 'Investor',
  },
  { name: 'C.C. Wei', title: 'Chairman and CEO, TSMC', primary_org: 'TSMC', category: 'Executive' },
  {
    name: 'David Holz',
    title: 'Founder, Midjourney',
  ...
  {
    name: 'Steve Huffman',
    title: 'Co-founder and CEO, Reddit',
    primary_org: 'Reddit',
    category: 'Executive',
  },
  {
    name: 'Masayoshi Son',
    title: 'Founder, Chairman, and CEO, SoftBank',
    primary_org: 'SoftBank',
    category: 'Investor',
  },
  {
    name: 'Adam Evans',
    title: 'EVP and GM, Salesforce AI',
  ...
  {
    name: 'Wang Xingxing',
    title: 'CEO, Unitree Robotics',
    primary_org: 'Unitree Robotics',
    category: 'Executive',
  },
  {
    name: 'Amnon Shashua',
    title: 'President and CEO, Mobileye',
  ...
  {
    name: 'Natasha Lyonne',
    title: 'Co-founder, Asteria Film Co.',
  ...
  {
    name: 'Alex Blania',
    title: 'Co-founder and CEO, Tools for Humanity',
    primary_org: 'Tools for Humanity',
    category: 'Executive',
  },
  {
    name: 'Maithra Raghu',
    title: 'Co-founder and CEO, Samaya AI',
    primary_org: 'Samaya AI',
    category: 'Executive',
  },
  { name: 'Rick Rubin', title: 'Music Producer', primary_org: null, category: 'Cultural figure' },
  {
    name: 'Mati Staniszewski',
    title: 'Co-founder and CEO, ElevenLabs',
    primary_org: 'ElevenLabs',
    category: 'Executive',
  },
  {
    name: 'Peggy Johnson',
    title: 'CEO, Agility Robotics',
    primary_org: 'Agility Robotics',
    category: 'Executive',
  },
  {
    name: 'James Peng',
  ...
  {
    name: 'Mfikeyi Makayi',
    title: 'CEO, KoBold Metals Africa',
    primary_org: 'KoBold Metals',
    category: 'Executive',
  },
  {
    name: 'Sam Rodriques',
    title: 'Co-founder and CEO, FutureHouse',
    primary_org: 'FutureHouse',
    category: 'Executive',
  },
  {
    name: 'Andy Parsons',
    title: 'Senior Director of Content Authenticity, Adobe',
    primary_org: 'Adobe',
    category: 'Executive',
  },
  {
    name: 'Navrina Singh',
    title: 'Founder and CEO, Credo AI',
    primary_org: 'Credo AI',
    category: 'Executive',
  },
  {
    name: 'David Ha',
  ...
  {
    name: 'Denise Herzing',
    title: 'Founder and Research Director, Wild Dolphin Project',
    primary_org: 'Wild Dolphin Project',
    category: 'Researcher',
  },
  {
    name: 'Mitesh Khapra',
  ...
  {
    name: 'Ana Helena Ulbrich',
    title: 'Co-founder and Director, NoHarm',
    primary_org: 'NoHarm',
    category: 'Organizer',
  },
  {
    name: 'Jeff Leek',
    title: 'VP and Chief Data Officer, Fred Hutchinson Cancer Center',
  ...
  {
    name: 'Fei-Fei Li',
    title: 'Co-director, Stanford HAI; CEO, World Labs',
...
function fuzzyMatch(name, existingNames) {
  ...
  for (const existing of existingNames) {
    ...
    if (nameParts.length >= 2 && existingParts.length >= 2) {
      ...
      const lastMatches =
        nameParts[nameParts.length - 1] === existingParts[existingParts.length - 1]
