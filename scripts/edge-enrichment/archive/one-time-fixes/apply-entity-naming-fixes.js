...
const NAME_CHANGES = [
  ...
  { id: 2113, from: "M12 (Microsoft's Venture Fund)", to: 'M12' },
  {
    ...
    to: 'Research Network on Opening Governance',
  },
  { id: 2115, from: 'MATS Research Inc.', to: 'MATS Research' },
  {
    id: 2116,
    from: 'MIT Quest for Intelligence (MIT Siegel Family Quest for Intelligence)',
    to: 'MIT Quest for Intelligence',
  },
  ...
  {
    id: 2142,
    from: 'National Defense Science and Engineering Graduate (NDSEG) Fellowship Program',
    to: 'NDSEG Fellowship',
  },
  { id: 2239, from: 'National Infrastructure Fund (Infra)', to: 'National Infrastructure Fund' },
  {
    ...
    to: 'National Telecommunications and Information Administration (NTIA)',
  },
  {
    id: 2153,
    from: 'Natural Sciences and Engineering Research Council of Canada',
    to: 'Natural Sciences and Engineering Research Council of Canada (NSERC)',
  },
  ...
  {
    id: 2310,
    from: 'Vanderbilt University Institute of National Security',
    to: 'Vanderbilt Institute of National Security',
  },
...
async function main() {
  ...
  for (const pa of PARENT_ASSIGNMENTS) {
    ...
    const parent = await rds.query('SELECT id, name FROM entity WHERE name = $1 AND status = $2', [
      pa.parentName,
      'approved',
    ])
