...
const FIELD_UPDATES = [
  // Category fixes
  {
    ...
    field: 'category',
    value: 'Frontier Lab',
    note: 'Hugging Face: primary is Frontier Lab not Infrastructure',
  },
  {
    id: 2053,
    field: 'other_categories',
    value: 'Infrastructure & Compute',
    note: 'Hugging Face: Infrastructure as secondary',
  },
  ...
  { id: 2144, field: 'other_categories', value: null, note: 'NIH: remove wrong VC/Philanthropy secondary' },
  {
    id: 2156,
    field: 'other_categories',
    value: 'Deployers & Platforms',
    note: 'Nebius: fix VC-backed to proper category',
  },
  ...
  { id: 2249, field: 'other_categories', value: null, note: 'SigIQ: remove wrong AI Safety secondary' },
  {
    ...
    field: 'other_categories',
    value: null,
    note: 'South Park Commons: remove Connector/convener (influence_type)',
  },
  ...
  { id: 2037, field: 'funding_model', value: 'Corporate/commercial', note: 'Accel: VC fund structure' }, // keeping as-is per schema
  {
    id: 2163,
    field: 'funding_model',
    value: 'Government (U.S. federal)',
    note: 'NY State: should be state but no enum for it',
  },
  ...
  // Stance fixes
  {
    ...
    value: 'Moderate',
    note: 'UK Government: updated from stale 2017 Light-touch',
  },
  { id: 2085, field: 'belief_ai_risk', value: 'Serious', note: 'Acemoglu: not Catastrophic, focuses on labor/power' }, // if not deleted
  {
    ...
    field: 'belief_regulatory_stance',
    value: 'Mixed/unclear',
    note: 'Renaissance Philanthropy: Obama OSTP veterans',
  },
  ...
  { id: 2254, field: 'belief_ai_risk', value: 'Unknown', note: 'SEE: fiscal sponsor has no view' },
  {
    ...
    field: 'belief_regulatory_stance',
    value: 'Mixed/unclear',
    note: 'Leverhulme Trust: broad funder, one AI safety grant',
  },
  { id: 2100, field: 'belief_ai_risk', value: 'Serious', note: 'Leverhulme: not Existential from one grant' },
  {
    ...
    value: 'Unknown',
    note: 'Ineffable Intelligence: no timeline statement found',
  },
  ...
  // Title fix
  {
    id: 2079,
    field: 'title',
    value: 'Individual donor and philanthropist',
    note: 'Julie Carson: remove spousal reference',
  },
]
...
async function main() {
  ...
  for (const update of validUpdates) {
    ...
    if (apply) {
      await rds.query(`UPDATE entity SET ${update.field} = $1 WHERE id = $2`, [update.value, update.id])
      console.log(`    ✅ Applied`)
    }
  }
