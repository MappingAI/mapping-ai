...
const DUPLICATE_PAIRS = [
  { keep: 1052, remove: 875, keepName: 'DAIR Institute', removeName: 'DAIR' },
  {
    keep: 1117,
    remove: 432,
    keepName: 'International Association for Safe and Ethical AI',
    removeName: 'International Association for Safe & Ethical AI (IASEAI)',
  },
  {
    keep: 947,
    remove: 1362,
    keepName: 'MIT CSAIL',
    removeName: 'MIT Computer Science & Artificial Intelligence Laboratory',
  },
