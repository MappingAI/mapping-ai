...
const REJECTIONS = [
  ...
  // Non-AI investments
  {
    funder: 'Andreessen Horowitz',
    recipient: 'KoBold Metals',
    reason: 'Mineral exploration for energy transition, not AI',
  },
  ...
  },
  {
    ...
    reason: 'Global health measurement programs, not AI',
  },
  ...
  // MacArthur Foundation
  {
    ...
    reason: 'Human rights/war crimes data analysis, not AI',
  },
  {
    funder: 'John D. and Catherine T. MacArthur Foundation',
    recipient: 'danah boyd',
    reason: 'General research funding, not AI-specific',
  },
  ...
  { funder: 'NSF', recipient: 'William Bialek', reason: 'Neuroscience/biophysics research, not AI' },
  {
    ...
    recipient: 'Arthur Spirling',
    reason: 'Linguistics/political text analysis, not AI',
  },
  {
    funder: 'National Science Foundation',
    recipient: 'Arvind Narayanan',
    reason: 'Cryptocurrency security/anonymity research, not AI',
  },
  { funder: 'National Science Foundation', recipient: 'Court Watch NOLA', reason: 'Criminal justice reform, not AI' },
  {
    funder: 'National Science Foundation',
    recipient: 'David Autor',
    reason: 'NSF CAREER Award for labor economics, not AI',
  },
  {
    funder: 'National Science Foundation',
    recipient: 'Emory University',
    reason: 'Research development professionals diversity program, not AI',
  },
  { funder: 'National Science Foundation', recipient: 'Giles Hooker', reason: 'General statistics award, not AI' },
  {
    funder: 'National Science Foundation',
    recipient: 'Kate Kellogg',
    reason: 'Organizational technology adoption, not AI research',
  },
  {
    funder: 'National Science Foundation',
    recipient: 'Ryan Calo',
    reason: 'NSF event organization role, not funding relationship',
  },
  {
    funder: 'National Science Foundation',
    recipient: 'Scott A. Strobel',
    reason: 'US-Peru field ecology training, not AI',
  },
  {
    funder: 'National Science Foundation',
    recipient: 'Speed School of Engineering',
    reason: 'Battery research, not AI',
  },
  ...
  // DOE non-AI grants
  {
    ...
    recipient: 'Jeff Hancock',
    reason: 'Social science research, not AI-specific',
  },
  {
    funder: 'U.S. Department of Energy',
    recipient: 'Carnegie Mellon University',
    reason: 'Decarbonization in steelmaking, not AI',
  },
  {
    funder: 'U.S. Department of Energy',
    recipient: 'Federation of American Scientists',
    reason: 'Building technologies energy efficiency, not AI',
  },
  {
    funder: 'U.S. Department of Energy',
    recipient: 'Idaho National Laboratory',
    reason: 'Nuclear reactor infrastructure, not AI',
  },
  {
    funder: 'U.S. Department of Energy',
    recipient: 'PCAST',
    reason: 'Administrative support for advisory committee, not AI',
  },
  {
    funder: 'U.S. Department of Energy',
    recipient: 'University of Tennessee',
    reason: 'Fusion energy materials design, not AI',
  },
]
