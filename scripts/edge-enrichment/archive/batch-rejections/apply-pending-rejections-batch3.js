...
const REJECTIONS = [
  ...
  {
    funder: 'Khosla Ventures',
    recipient: 'Glydways',
    reason: 'Autonomous transit pods, mobility infrastructure not AI',
  },
  ...
  {
    funder: 'NATIONAL AIR TRAFFIC CONTROLLERS ASSOCIATION',
    recipient: 'Valerie Foushee',
    reason: 'Union PAC political donation',
  },
  ...
  {
    funder: 'OFFSHORE MARINE SERVICE ASSOCIATION',
    recipient: 'Maria Cantwell',
    reason: 'Offshore marine industry PAC',
  },
  ...
  {
    funder: 'Palmer Luckey',
    recipient: '58th Presidential Inaugural Committee',
    reason: 'Trump inauguration donation',
  },
  ...
  {
    funder: 'Konstantin Sokolov',
    recipient: 'Munich Security Conference Foundation',
    reason: 'Security conference endowment, not AI',
  },
  ...
  {
    funder: 'Kyunghyun Cho',
    recipient: 'Soongsil University',
    reason: 'Korean literature department donation, not AI',
  },
  ...
  {
    funder: 'Laurance S. Rockefeller/Rockefeller Brothers',
    recipient: 'Sherry Turkle',
    reason: 'Endowed professorship, general chair not AI grant',
  },
  {
    funder: 'Laurene Powell Jobs',
    recipient: 'Waverley Street Foundation',
    reason: 'Climate-focused philanthropy, not AI',
  },
  {
    funder: 'Laurene Powell Jobs',
    recipient: 'XQ Super School Project',
    reason: 'High school education project, not AI',
  },
  { funder: 'Leinweber Foundation', recipient: 'MIT', reason: 'Theoretical physics research, not AI' },
  {
    funder: 'Leinweber Foundation',
    recipient: 'Stanford University',
    reason: 'Stanford Institute for Theoretical Physics, not AI',
  },
  ...
  {
    funder: 'Lise and Giuseppe Racanelli Foundation',
    recipient: 'HEC Montréal',
    reason: 'Business school donation, not AI',
  },
  ...
  {
    funder: 'Lynn and Sherry Nichols',
    recipient: 'Wichita State University',
    reason: 'UAV flight testing facility, not AI',
  },
  ...
  {
    funder: 'MIT Knight Science Journalism',
    recipient: 'Karen Hao',
    reason: 'Science journalism fellowship, not AI research',
  },
  ...
  { funder: 'MUSIC joint venture', recipient: 'Splice', reason: 'Music platform, not AI' },
  {
    ...
    recipient: 'Community Solutions International',
    reason: 'Homelessness initiative, not AI',
  },
  { funder: 'MacArthur Foundation', recipient: 'RF Catalytic Capital', reason: 'Economic justice, not AI' },
  {
    funder: 'MacArthur Foundation',
    recipient: 'The Leadership Conference Education Fund',
    reason: 'Civil rights general operations, not AI',
  },
  ...
  {
    funder: 'Margaret Mitchell',
    recipient: 'Morehouse College students',
    reason: 'Historical 1940s education philanthropy',
  },
  {
    funder: 'Mastercard Impact Fund',
    recipient: 'Public Interest Technology University Network',
    reason: 'General tech education network, not AI-specific',
  },
  ...
  { funder: 'Max Planck Society', recipient: 'John A. Bargh', reason: 'Social psychology research prize, not AI' },
  {
    ...
    recipient: 'Wichita State University',
    reason: 'Humanities internship program, not AI',
  },
  ...
  {
    funder: 'Montréal Exchange',
    recipient: 'HEC Montréal Foundation',
    reason: 'Financial derivatives scholarship, not AI',
  },
  ...
  {
    funder: 'Mussafer Family Foundation',
    recipient: 'Tulane University',
    reason: 'Career readiness/internship, not AI',
  },
  { funder: 'NASA', recipient: 'Matthew Johnson-Roberson', reason: 'Satellite swarms space technology, not AI' },
  {
    funder: 'NASA Ames Research Center',
    recipient: 'Bay Area Environmental Research Institute',
    reason: 'Earth science/environmental research, not AI',
  },
  {
    funder: 'NASA Ames Research Center',
    recipient: 'SBIR/STTR program recipients',
    reason: 'General NASA small business grants',
  },
  ...
  { funder: 'NTIA', recipient: 'Zito Media Communications', reason: 'Rural broadband deployment, not AI' },
  {
    ...
    reason: 'Climate policy/Justice 40, not AI',
  },
  {
    funder: 'National Academy of Sciences',
    recipient: 'Ryan Calo',
    reason: 'Honorary events organization, not funding grant',
  },
  {
    funder: 'National Association of Manufacturers',
    recipient: 'Joint Economic Committee',
    reason: 'Manufacturing lobby political activity',
  },
  {
    funder: 'National Association of Wholesaler-Distributors',
    recipient: 'Joint Economic Committee',
    reason: 'Wholesale industry lobbying',
  },
  {
    funder: 'National Bureau of Economic Research',
    recipient: 'Danielle Li',
    reason: 'Faculty research fellow affiliation, not funding',
  },
  ...
  {
    funder: 'National Center for Advancing Translational Research',
    recipient: 'Baylor College of Medicine',
    reason: 'Clinical/translational biomedical, not AI',
  },
  {
    funder: 'National Endowment for the Humanities',
    recipient: 'Hélène Landemore',
    reason: 'Humanities lecture course award, not AI',
  },
  {
    funder: 'National Institute of General Medical Sciences',
    recipient: 'University of Louisville',
    reason: 'Clinical research, not AI',
  },
  {
    funder: 'National Institute of Health',
    recipient: 'Bei Xiao',
    reason: 'Human material perception psychology, not AI',
  },
  {
    funder: 'National Institute of Mental Health',
    recipient: 'Carnegie Mellon University',
    reason: '1950s historical computer funding, not current AI grant',
  },
  ...
  {
    funder: 'NIST',
    recipient: 'Michigan Manufacturing Technology Center',
    reason: 'Manufacturing supply chain, not AI',
  },
  {
    funder: 'NIST',
    recipient: 'Norwich University Applied Research Institutes',
    reason: 'Cybersecurity/research general, no clear AI tie',
  },
  ...
  {
    funder: 'National Retail Federation',
    recipient: 'Georgetown University',
    reason: 'Retail business initiative, not AI',
  },
  ...
  { funder: 'Nestlé', recipient: 'UNESCO', reason: 'Youth projects/grants/training, not AI' },
  {
    ...
    recipient: 'NYS Office of Information Technology Services',
    reason: 'General state IT procurement, not AI',
  },
  {
    funder: 'New York State Assembly',
    recipient: 'AMDeC Research Facility',
    reason: 'Medical/research facility, not AI',
  },
  {
    funder: 'New York State Assembly',
    recipient: 'Bedford Stuyvesant Family Health Center',
    reason: 'Community health center, not AI',
  },
  ...
  { funder: 'New York State Assembly', recipient: 'Queens Museum of Art', reason: 'Art museum, not AI' },
  {
    ...
    reason: 'General capital maintenance, not AI',
  },
  {
    funder: 'Norman Barry Foundation',
    recipient: 'Dr Swati Gupta',
    reason: 'Wrong person - NZ scientist, not Georgia Tech AI researcher',
  },
  { funder: 'North Carolina General Assembly', recipient: 'UNC System', reason: 'Nursing education expansion, not AI' },
  {
    funder: 'Northern Illinois Community Initiatives',
    recipient: 'Think Big!',
    reason: 'Women/minority entrepreneurship, not AI',
  },
  ...
  {
    funder: "Norway's International Climate and Forest Initiative",
    recipient: 'Pulitzer Center',
    reason: 'Climate/rainforest journalism, not AI',
  },
  {
    funder: 'Norwegian Agency for Development Cooperation',
    recipient: 'Pulitzer Center',
    reason: 'Climate journalism, not AI',
  },
  {
    funder: 'Oak Foundation',
    recipient: 'Human Rights Data Analysis Group',
    reason: 'Human rights data/war crimes, not AI',
  },
  { funder: 'Oberlin College', recipient: 'Nick Winter', reason: 'General student entrepreneurship grant, not AI' },
  {
    ...
    reason: 'Refugee services block grant, not AI',
  },
  {
    funder: 'Office of Science and Technology Policy',
    recipient: 'PCAST',
    reason: 'Administrative budget, not AI grant',
  },
  {
    funder: 'Office of the Governor of Indiana',
    recipient: '15 regions',
    reason: 'Quality of place/life initiative, not AI',
  },
  {
    funder: 'Office of the Governor of Indiana',
    recipient: 'broadband service providers',
    reason: 'Broadband connectivity, not AI',
  },
  { funder: 'Omidyar Network', recipient: 'Garrison Lovely', reason: 'Employment relationship, not external grant' },
  {
    ...
    recipient: 'Pulitzer Center',
    reason: 'Journalism general operating support, not AI',
  },
  ...
  {
    funder: 'Orland Bethel Family Foundation',
    recipient: 'University of Pittsburgh',
    reason: 'Musculoskeletal research expansion, not AI',
  },
  {
    funder: 'Osage University Partners',
    recipient: 'University of Pennsylvania',
    reason: 'BioNTech therapeutic drugs, not AI',
  },
  {
    funder: 'Otoki Ham Tae-ho Foundation',
    recipient: 'Seoul National University',
    reason: 'General university donations, not AI',
  },
  {
    funder: 'Oxford Internet Institute',
    recipient: 'Samantha Bradshaw',
    reason: 'DPhil student affiliation, not grant',
  },
  ...
  {
    funder: 'Patrick Collison',
    recipient: 'Open Philanthropy Abundance and Growth Fund',
    reason: 'Housing/infrastructure regulatory reform, not AI',
  },
  {
    funder: 'Paul & Daisy Soros Fellowship',
    recipient: 'Alvaro Bedoya',
    reason: 'Legal fellowship for privacy/tech lawyer, not AI',
  },
  {
    funder: 'Paul & Daisy Soros Fellowships',
    recipient: 'Tarun Chhabra',
    reason: 'Indian-American scholarship program, not AI',
  },
  ...
  {
    funder: 'Perry World House',
    recipient: 'Samantha Bradshaw',
    reason: 'Fellowship at foreign policy center, not AI',
  },
  ...
  {
    funder: 'Phi Beta Kappa Society',
    recipient: 'The American Scholar',
    reason: 'Academic society magazine support, not AI',
  },
  { funder: 'Phillip (Terry) Ragon', recipient: 'MIT', reason: 'Giant Magellan Telescope astronomy, not AI' },
  {
    funder: 'Pierre Lassonde Family Foundation',
    recipient: 'Polytechnique Montréal',
    reason: 'General natural sciences research, not AI',
  },
  ...
  {
    funder: 'Players Philanthropy Fund',
    recipient: 'Transgender Law Center',
    reason: 'LGBTQ legal organization, not AI',
  },
  ...
  { funder: 'Puppy Up Foundation', recipient: 'Princeton University', reason: 'Canine mammary tumor research, not AI' },
  {
    ...
    recipient: 'Centre for Future Generations',
    reason: 'Climate governance, not AI',
  },
  ...
  {
    funder: 'Randall R. Kendrick',
    recipient: 'USC Marshall School of Business',
    reason: 'Global supply chain management, not AI',
  },
  {
    funder: 'Refik Anadol',
    recipient: 'Turkiye Entrepreneurship Foundation',
    reason: 'AI artist donation to general entrepreneurship, not AI',
  },
  ...
  { funder: 'Resilience Reserve', recipient: 'Aether', reason: 'Nanoscale molecule assembly, not AI' },
  {
    ...
    reason: 'General Oxford college scholarships, not AI',
  },
