...
const REJECTIONS = [
  ...
  {
    funder: 'Rich patrons',
    recipient: 'Scott Alexander',
    reason: 'Substack/patron informal gifts, not structured AI funding',
  },
  ...
  {
    funder: 'Richard Calabrese',
    recipient: 'Georgetown University',
    reason: 'STEM/medical scholarships bequest, not AI',
  },
  {
    funder: 'Richard King Mellon Foundation',
    recipient: 'Carnegie Mellon University',
    reason: 'General CMU grant, no AI program described',
  },
  {
    funder: 'Richard Phillips',
    recipient: 'Saint Thomas Aquinas High School',
    reason: 'High school scholarship, not AI',
  },
  {
    funder: 'Richard Phillips',
    recipient: 'Saint Thomas Aquinas High School students',
    reason: 'High school scholarship, not AI',
  },
  ...
  { funder: 'Rives Croissance', recipient: 'Forward Global', reason: 'Strategic consulting firm, not AI' },
  {
    ...
    recipient: 'Munich Security Conference Foundation',
    reason: 'Security conference donation, not AI',
  },
  {
    funder: 'Robert David Lion Gardiner Foundation',
    recipient: 'Columbia University',
    reason: 'Digital humanities/historical mapping, not AI',
  },
  {
    funder: 'Robert J. Jones',
    recipient: 'Illinois Commitment program',
    reason: 'University scholarship contribution, not AI',
  },
  {
    funder: 'Robert Wood Johnson Foundation',
    recipient: 'Brookings',
    reason: 'Health research think tank support, not AI',
  },
  {
    funder: 'Robert Wood Johnson Foundation',
    recipient: 'RAND Corporation',
    reason: 'Health/education research, not AI',
  },
  { funder: 'Robina Foundation', recipient: 'Yale Law School', reason: 'Human rights law endowment, not AI' },
  {
    ...
    recipient: 'Roosevelt Institute',
    reason: 'Progressive economic policy support, not AI',
  },
  ...
  {
    funder: 'Ronald and Marianne Renaud',
    recipient: 'USC Marshall School of Business',
    reason: 'Healthcare innovation business program, not AI',
  },
  ...
  {
    funder: 'Sean McGarvey',
    recipient: 'International Union of Painters',
    reason: 'Union political committee donation',
  },
  { funder: 'Sean McGarvey', recipient: 'Iupat Member and Family Fundraising', reason: 'Union political committee' },
  {
    funder: 'Sean McGarvey',
    recipient: 'Political Educational Fund of Building Trades',
    reason: 'Union political fund',
  },
  ...
  {
    funder: 'Saikat Chakrabarti',
    recipient: 'Saikat Chakrabarti congressional campaign',
    reason: 'Self-funded political campaign',
  },
  ...
  {
    funder: "Saudi Arabia's Public Investment Fund",
    recipient: 'SpaceX',
    reason: 'Space launch company investment, not AI',
  },
  { funder: 'Scott Alexander', recipient: 'Kasey Markel', reason: 'ACX grant for corn/agriculture, not AI' },
  {
    funder: 'Scottish Youth Hostel Association',
    recipient: 'Malcolm Murray',
    reason: 'Hostel accommodation for charity walk, not AI',
  },
  { funder: 'Seattle Foundation', recipient: 'Duy Nguyen', reason: 'General scholarship support, not AI' },
  {
    funder: 'Secretaría de Políticas Universitarias',
    recipient: 'Universidad de Buenos Aires',
    reason: 'Argentine university research, not AI',
  },
  {
    funder: 'Shuttleworth Foundation',
    recipient: 'Cory Doctorow',
    reason: 'Honorary steward appointment, not financial grant',
  },
  {
    funder: 'Sigrid Rausing Trust',
    recipient: 'Human Rights Data Analysis Group',
    reason: 'Human rights/war crimes data, not AI',
  },
  ...
  {
    funder: 'South Korean government',
    recipient: 'Seoul National University',
    reason: 'General university spending target, not AI',
  },
  { funder: 'Spencer Cox', recipient: 'International Rescue Committee', reason: 'Refugee charity fundraising, not AI' },
  {
    funder: 'Stanley and Rosemary Hayes Jones',
    recipient: 'George Mason University',
    reason: 'Networking testbed lab, not AI',
  },
  {
    funder: 'State of California',
    recipient: '37 startups',
    reason: 'General small business innovation grants, not AI',
  },
  {
    funder: 'State of California',
    recipient: 'California Workforce Development Board and CalTrans',
    reason: 'Highway workforce training, not AI',
  },
  {
    funder: 'State of California',
    recipient: 'Discovery Science Center of Orange County',
    reason: 'Science museum, not AI',
  },
  { funder: 'State of California', recipient: 'homelessness regions', reason: 'Homeless prevention, not AI' },
  {
    funder: 'State of California Department of Health Care Access',
    recipient: 'USC Social Work',
    reason: 'Substance use disorder training, not AI',
  },
  ...
  {
    funder: 'State of Kentucky',
    recipient: 'University of Louisville',
    reason: 'Health sciences building capital project, not AI',
  },
  ...
  {
    funder: 'State of Ohio',
    recipient: '44 law enforcement agencies',
    reason: 'Violent crime reduction grants, not AI',
  },
  { funder: 'State of Texas', recipient: 'Blue Origin', reason: 'Space rocket propulsion, not AI' },
  {
    funder: "State of Utah - Attorney General's Office",
    recipient: 'Melissa Holyoak',
    reason: 'Salary payment, not grant',
  },
  {
    funder: 'Stavros Niarchos Foundation',
    recipient: 'Columbia University',
    reason: 'Precision psychiatry/mental health, not AI',
  },
  ...
  {
    funder: 'Stuart and Molly Sloan',
    recipient: 'Fred Hutchinson Cancer Center',
    reason: 'Cancer center gift, not AI',
  },
  {
    funder: 'Survival and Flourishing Fund',
    recipient: 'Good Ancestor Foundation',
    reason: 'General EA/longtermist support, no clear AI focus',
  },
  ...
  {
    funder: 'Suzanne Dworak-Peck',
    recipient: 'USC School of Social Work',
    reason: 'Social work school endowment, not AI',
  },
  {
    funder: 'Suzanne Kelley',
    recipient: 'Block Center for Technology and Society',
    reason: 'General tech/society, not AI-specific',
  },
  ...
  {
    funder: 'TEDCO',
    recipient: 'Players Philanthropy Fund',
    reason: 'Maryland tech grant to philanthropy fund, not AI',
  },
  { funder: 'Tadashi Yanai', recipient: 'UCLA', reason: 'Japan-US university initiative, not AI' },
  {
    funder: 'Tanka Foundation',
    recipient: 'Centre for Future Generations',
    reason: 'General EA operating support, not AI',
  },
  ...
  { funder: 'Ted Turner', recipient: 'United Nations Foundation', reason: 'UN general support, not AI' },
  {
    ...
    recipient: 'Denise Herzing',
    reason: 'Dolphin communication research, not AI',
  },
  { funder: 'Tencent', recipient: 'Reddit', reason: 'Social media platform investment, not AI' },
  {
    funder: 'Tennessee Department of Economic and Community Development',
    recipient: 'Vanderbilt University',
    reason: 'Transportation/automotive grants, not AI',
  },
  {
    funder: 'Tennessee Valley Authority',
    recipient: 'University of Tennessee',
    reason: 'Nuclear engineering chair endowment, not AI',
  },
  { funder: 'Texas Blockchain Council', recipient: 'Cynthia Lummis', reason: 'Crypto industry political donation' },
  {
    funder: 'The Andrew H. And Ann R. Tisch Foundation',
    recipient: 'Brookings',
    reason: 'General think tank support, not AI',
  },
  {
    funder: 'The Andrew W. Mellon Foundation',
    recipient: 'NYU',
    reason: 'Cultural knowledge/data protection indigenous, not AI',
  },
  {
    funder: 'The Atlantic Philanthropies',
    recipient: 'Leadership Conference on Civil Rights',
    reason: 'Civil rights general support, not AI',
  },
  { funder: 'The Atlantic Philanthropies', recipient: 'Yale Law School', reason: 'Human rights litigation, not AI' },
  {
    funder: 'The Ballmer Group',
    recipient: 'Stanford Center on Poverty and Inequality',
    reason: 'Tax/Census data infrastructure, not AI',
  },
  {
    funder: 'The Bill and Donna Marriott Foundation',
    recipient: 'Mayo Clinic',
    reason: 'Healthcare transformation, not AI',
  },
  ...
  {
    funder: 'The J. Willard and Alice S. Marriott Foundation',
    recipient: 'Mayo Clinic',
    reason: 'Healthcare philanthropy, not AI',
  },
  { funder: 'The Jefferson Trust', recipient: 'University of Virginia', reason: 'General UVA initiatives, not AI' },
  {
    funder: 'The Kellner Family Foundation',
    recipient: 'Charles University',
    reason: 'International scientists visiting, not AI',
  },
  { funder: 'The LAD Climate Fund', recipient: 'Centre for Future Generations', reason: 'Climate governance, not AI' },
  {
    ...
    reason: 'Education, not AI',
  },
  {
    funder: 'The Long Term for Planet and People foundation',
    recipient: 'Centre for Future Generations',
    reason: 'Climate/environment, not AI',
  },
  ...
  {
    funder: 'The McGraw-Hill Companies',
    recipient: 'LinkedIn',
    reason: 'Publishing company investing in professional network, not AI',
  },
  {
    funder: 'The National Endowment for Democracy',
    recipient: 'Human Rights Data Analysis Group',
    reason: 'Human rights data, not AI',
  },
  { funder: 'The Navigation Fund', recipient: 'Food System Innovations', reason: 'Food/agriculture systems, not AI' },
  {
    ...
    recipient: 'Vanguard Charitable Endowment Program',
    reason: 'Criminal justice reform, not AI',
  },
  ...
  { funder: 'The Operating Group', recipient: 'Zodia Markets', reason: 'Crypto exchange, not AI' },
  {
    ...
    recipient: 'Forward Global',
    reason: 'International development experts hub, not AI',
  },
  {
    funder: 'The Rockefeller Foundation',
    recipient: 'RadicalxChange Foundation',
    reason: 'Governance/democracy tech, not AI',
  },
  {
    funder: 'The Silicon Valley Community Foundation',
    recipient: 'Centre for Future Generations',
    reason: 'General EA operating support, not AI',
  },
  {
    ...
    recipient: 'RAND Corporation',
    reason: 'Health/education/safety research, not AI',
  },
  {
    funder: 'Thermo Fisher Scientific',
    recipient: 'University of Melbourne',
    reason: 'Biomedical/genomics research, not AI',
  },
  { funder: 'Thomas A. Russo', recipient: 'Dartmouth College', reason: 'Undergraduate housing gift, not AI' },
  {
    ...
    recipient: 'Priya Donti',
    reason: 'Pre-PhD travel fellowship, not AI research funding',
  },
  ...
  {
    funder: 'Toby Ord',
    recipient: 'charities working in poorest countries',
    reason: 'Global health charities, not AI',
  },
  {
    funder: 'Tom Bye and David Bohne',
    recipient: 'UCLA Department of Linguistics',
    reason: 'Linguistics endowed chair, not AI',
  },
  ...
  {
    funder: 'Twenty-nine Dartmouth families',
    recipient: 'Dartmouth College',
    reason: 'University housing gift, not AI',
  },
  { funder: 'Twine Ventures', recipient: 'Wall Street Journal', reason: 'Media company investment, not AI' },
  {
    ...
    recipient: 'Ohio Department of Job and Family Services',
    reason: 'SNAP recertification IT, not AI',
  },
  {
    funder: 'U.S. Department of Education',
    recipient: 'UNC System',
    reason: 'Academic degree access/technical upgrades, not AI',
  },
  {
    funder: 'U.S. Department of Energy OEM',
    recipient: 'Vanderbilt University',
    reason: 'Environmental management/nuclear risk, not AI',
  },
  {
    funder: 'U.S. Department of Energy Office of Nuclear Energy',
    recipient: 'Idaho National Laboratory',
    reason: 'Nuclear reactor innovation, not AI',
  },
  {
    funder: 'U.S. Dept. of HHS',
    recipient: 'USC Social Work',
    reason: 'Scholarships for social work students, not AI',
  },
  {
    funder: 'U.S. Dept. of HHS Administration for Children and Families',
    recipient: 'Ohio DJFS',
    reason: 'Early childhood care/education, not AI',
  },
  {
    funder: 'U.S. Department of Labor',
    recipient: 'American Indians/Alaska Natives',
    reason: 'Employment/training for indigenous communities, not AI',
  },
  {
    funder: 'U.S. Department of Labor',
    recipient: 'Ohio Reentry Entities',
    reason: 'Prison reentry workforce programs, not AI',
  },
  { funder: 'U.S. Department of Labor', recipient: 'State Workforce Agencies', reason: 'Skills training fund, not AI' },
  {
    funder: 'U.S. Department of Labor',
    recipient: 'public-private partnerships',
    reason: 'Infrastructure jobs workforce training, not AI',
  },
  {
    funder: 'U.S. Department of Labor',
    recipient: 'states and territories',
    reason: 'Registered Apprenticeship expansion, not AI',
  },
  {
    funder: 'U.S. Department of State',
    recipient: '47 exchange alumni teams',
    reason: 'Citizen diplomacy fund, not AI',
  },
  {
    funder: 'U.S. Department of Transportation',
    recipient: 'Illinois transportation projects',
    reason: 'Highway/rail infrastructure, not AI',
  },
  {
    funder: 'U.S. Department of Transportation',
    recipient: 'Mississippi infrastructure projects',
    reason: 'Freight corridor infrastructure, not AI',
  },
  {
    funder: 'U.S. Department of Transportation',
    recipient: 'Research Triangle Park',
    reason: 'Multimodal transportation center, not AI',
  },
  {
    funder: 'U.S. Department of Transportation',
    recipient: 'cities, counties',
    reason: 'Roadway safety improvements, not AI',
  },
  {
    funder: 'U.S. House of Representatives',
    recipient: "Hawai'i State Department of Law Enforcement",
    reason: 'Law enforcement funding, not AI',
  },
  {
    funder: 'U.S. House of Representatives',
    recipient: 'University of Hawaii Sea Grant',
    reason: 'Marine/ocean research, not AI',
  },
  {
    funder: 'U.S. National Science Foundation',
    recipient: 'quantum and nanotechnology sites',
    reason: 'Quantum/nanoscale facilities, not AI',
  },
  {
    funder: 'U.S. Space Force',
    recipient: 'University of Michigan',
    reason: 'Spacecraft maneuvering research, not AI',
  },
  {
    funder: 'U.S. Treasury Department',
    recipient: 'State of Colorado',
    reason: 'Small business credit initiative, not AI',
  },
  { funder: 'UAE Zayed Award', recipient: 'António Guterres', reason: 'Human fraternity prize, not AI' },
  {
    funder: 'UC Law SF Foundation',
    recipient: 'Veena Dubal',
    reason: 'Outstanding scholarship award for labor law, not AI',
  },
  {
    funder: 'UK Atomic Energy Authority',
    recipient: 'University of Oxford',
    reason: 'Physics/materials science research, not AI',
  },
  {
    funder: 'UOB',
    recipient: 'Singapore Management University',
    reason: 'Asian enterprise/business institute, not AI',
  },
  ...
  {
    funder: 'Universidad de Buenos Aires',
    recipient: '97 research projects',
    reason: 'General university-funded research, not AI',
  },
  {
    funder: 'University of Cambridge',
    recipient: 'Cavendish Laboratory',
    reason: 'Physics laboratory matching funds, not AI',
  },
  {
    funder: 'University of Louisville',
    recipient: 'Health Equity Innovation Hub',
    reason: 'Health equity research hub, not AI',
  },
  {
    funder: 'University of Louisville',
    recipient: 'Health Sciences Building',
    reason: 'Capital construction for health sciences, not AI',
  },
  {
    funder: 'University of Louisville',
    recipient: 'Louisville Clinical and Translational Research Center',
    reason: 'Clinical research matching funds, not AI',
  },
  {
    funder: 'University of North Carolina System',
    recipient: '12 public universities',
    reason: 'Nursing education expansion, not AI',
  },
  {
    funder: 'University of Pittsburgh',
    recipient: 'Pittsburgh (city)',
    reason: 'Neighborhood revitalization/public safety, not AI',
  },
  {
    funder: 'University of Virginia',
    recipient: 'David LaCross gift',
    reason: 'Business school matching funds, not AI',
  },
  {
    funder: 'University of Virginia',
    recipient: 'UVA Clark Scholars Program',
    reason: 'Engineering scholarship, not AI-specific',
  },
  ...
  { funder: 'V Foundation for Cancer Research', recipient: 'Richard Phillips', reason: 'Cancer research fund, not AI' },
  {
    funder: 'VicHealth',
    recipient: 'University of Melbourne',
    reason: 'Racism/public health postdoctoral fellowships, not AI',
  },
  ...
  {
    funder: 'Walter Isaacson',
    recipient: 'Isaacson School for New Media',
    reason: 'Journalism/media school donation, not AI',
  },
  {
    funder: 'Washington Research Foundation',
    recipient: 'Fred Hutchinson Cancer Center',
    reason: 'Cancer center technology collaboration, not AI',
  },
  ...
  {
    funder: 'Wells Fargo Strategic Capital',
    recipient: 'Arkose Labs',
    reason: 'Online fraud prevention cybersecurity, not AI',
  },
  {
    funder: 'William & Flora Hewlett Foundation',
    recipient: 'Leadership Conference Education Fund',
    reason: 'K-12 teaching/learning, not AI',
  },
  {
    funder: 'William and Flora Hewlett Foundation',
    recipient: 'MIT Sloan Sustainability Initiative',
    reason: 'Sustainable asset management research, not AI',
  },
  {
    funder: 'Winston Churchill Foundation',
    recipient: 'Sam Rodriques',
    reason: 'Churchill Scholarship, not AI-specific research grant',
  },
  ...
  {
    funder: 'Zennström Philanthropies',
    recipient: 'Human Rights Data Analysis Group',
    reason: 'Human rights data analysis, not AI',
  },
  {
    funder: 'entities in Qatar',
    recipient: 'Georgetown University',
    reason: 'Foreign funding, primarily political/educational, not AI',
  },
  {
    funder: 'global institutional investors',
    recipient: 'Metaplanet',
    reason: 'Bitcoin company capital raise, not AI',
  },
  ...
  {
    funder: 'Sanjeev Arora',
    recipient: 'Chief Minister Rangla Punjab Fund',
    reason: 'Wrong person - Indian politician, not Princeton CS professor',
  },
  { funder: 'Techstars', recipient: 'Meta', reason: 'Implausible data error - Techstars investing in Meta 2024' },
  {
    funder: 'UC Berkeley EECS Department',
    recipient: 'Nathan Lambert',
    reason: 'Employment stipend, not external grant',
  },
  {
    funder: 'Veritex Community Bank',
    recipient: 'David S Krueger',
    reason: 'Wrong person - insurance agent, not AI researcher',
  },
  {
    funder: 'a16z Bio Health',
    recipient: 'Midjourney',
    reason: 'Likely attribution error - life sciences fund investing in AI image generator',
  },
  {
    funder: 'donor (unnamed)',
    recipient: 'USC Marshall School of Business',
    reason: 'Wrong institution - citation describes Wharton',
  },
