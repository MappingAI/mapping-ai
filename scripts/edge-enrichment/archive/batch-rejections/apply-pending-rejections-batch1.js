...
const REJECTIONS = [
  ...
  {
    funder: 'A. James & Alice B. Clark Foundation',
    recipient: 'University of Virginia',
    reason: 'General scholarship program',
  },
  {
    funder: 'AAAS Leshner Leadership Institute',
    recipient: 'Michael Littman',
    reason: 'Science communication fellowship',
  },
  ...
  {
    funder: 'AMERICAN FEDERATION OF STATE, COUNTY AND MUNICIPAL EMPLOYEES',
  ...
  {
    funder: 'Alex Hanna',
    recipient: 'University of Wisconsin-Madison Sociology',
    reason: 'LGBTQ+ sociology scholarship',
  },
  {
    funder: 'Alexandria Ocasio-Cortez',
    recipient: 'Democratic Congressional Campaign Committee',
    reason: 'Political party donation',
  },
  ...
  {
    funder: 'American Online Giving Foundation',
    recipient: 'Wild Dolphin Project',
    reason: 'Marine wildlife research',
  },
  ...
  {
    funder: 'Australian Medical Research Future Fund',
  ...
  {
    funder: 'Ben Horowitz',
    recipient: 'entities supporting Harris Walz campaign',
    reason: 'General political donation',
  },
  ...
  {
    funder: 'California Department of General Services',
    recipient: 'K-12 schools',
    reason: 'General state procurement',
  },
  {
    funder: 'California Department of Technology',
    recipient: 'California state departments',
    reason: 'General IT modernization',
  },
  {
    funder: 'California Department of Technology',
    recipient: 'eligible organizations',
    reason: 'Digital equity/broadband',
  },
  ...
  {
    funder: 'Charles Pankow Foundation',
    recipient: 'Federation of American Scientists',
    reason: 'Construction industry',
  },
  ...
  {
    funder: 'Community Bankers Association of Illinois',
    recipient: 'Joint Economic Committee',
    reason: 'Banking industry PAC',
  },
  ...
  { funder: 'Craig Newmark Philanthropies', recipient: 'Columbia Journalism School', reason: 'Journalism ethics' },
  {
    ...
    recipient: 'Cybercrime Support Network',
    reason: 'Cybercrime victim support',
  },
  ...
  {
    funder: "Crédit Agricole d'Ile-de-France",
    recipient: 'Collège de France',
    reason: 'Heritage cultural sponsorship',
  },
  ...
  {
    funder: 'Dayton Development Coalition',
    recipient: 'Joint Economic Committee',
    reason: 'Regional economic development',
  },
