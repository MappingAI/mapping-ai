...
const REJECTIONS = [
  ...
  { funder: 'Bill Gates', recipient: 'KoBold Metals', reason: 'NAR: Copper mining project' },
  {
    ...
    reason: 'NAR: Molecular Biotechnology (1990s biomedical)',
  },
  {
    funder: 'Carnegie Corporation of New York',
    recipient: 'Federation of American Scientists',
    reason: 'NAR: Nuclear stability research',
  },
  {
    funder: 'Carnegie Corporation of New York',
    recipient: 'Ganesh Sitaraman',
    reason: 'NAR: Constitutional law fellowship',
  },
  {
    funder: 'Carnegie Corporation of New York',
    recipient: 'Nathaniel Persily',
    reason: 'NAR: Democracy research fellowship',
  },
  {
    funder: 'Carnegie Corporation of New York',
    recipient: 'Zeynep Tufekci',
    reason: 'NAR: Democracy/international order fellowship',
  },
  ...
  { funder: 'Ford Foundation', recipient: 'ACLU', reason: 'NAR: Civil liberties endowment' },
  {
    ...
    recipient: 'Center for Strategic and International Studies (CSIS)',
    reason: 'NAR: No AI description in citation',
  },
  ...
  { funder: 'Ford Foundation', recipient: 'Washington Post', reason: 'NAR: Media/journalism funding' },
  {
    ...
    recipient: 'Bipartisan Policy Center',
    reason: 'NAR: Higher education finance modeling',
  },
  { funder: 'Gates Foundation', recipient: 'Mozilla Foundation', reason: 'NAR: Agricultural development' },
  {
    funder: 'Gates Foundation',
    recipient: 'Stanford University',
    reason: 'NAR: Global health (monoclonal antibodies)',
  },
  ...
  {
    funder: 'MIT GOV/LAB',
    recipient: 'Stuart Russell',
    reason: 'WC: Wrong person (political science PhD, not AI researcher)',
  },
  ...
  {
    funder: 'Marsha Blackburn',
    recipient: 'National Republican Senatorial Committee',
    reason: 'POL: Political donation',
  },
  ...
  { funder: 'Microsoft Corp', recipient: 'John Hickenlooper', reason: 'POL: Political campaign donation' },
  {
    ...
    reason: 'NAR: General biomedical research',
  },
  ...
  { funder: 'U.S. Department of Commerce', recipient: 'NTIA', reason: 'NAR: Broadband/digital inclusion' },
  {
    ...
    reason: 'NAR: Truth commission work',
  },
  { funder: 'University of Michigan', recipient: 'Hélène Landemore', reason: 'NF: Lecture honorarium, not grant' },
  {
    ...
    recipient: 'Matthew Johnson-Roberson',
    reason: 'NF: University award, not grant',
  },
  ...
  { funder: 'Vox Media', recipient: 'Ezra Klein', reason: 'NF: Employment, not funding' },
  {
    ...
    recipient: 'Effective Institutions Project',
    reason: 'NAR: Governance reform',
  },
  {
    funder: 'William and Flora Hewlett Foundation',
    recipient: 'MIT Shaping the Future of Work Initiative',
    reason: 'NAR: Labor policy research',
  },
