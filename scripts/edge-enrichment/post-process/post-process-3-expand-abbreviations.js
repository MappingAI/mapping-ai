...
const ABBREVIATION_MAPPINGS = [
  ...
  {
    abbrev: 'OSTP',
    fullName: 'Office of Science and Technology Policy',
    existingName: 'Office of Science and Technology Policy (OSTP)',
  },
  ...
  {
    abbrev: 'MIRI',
    fullName: 'Machine Intelligence Research Institute',
    existingName: 'Machine Intelligence Research Institute (MIRI)',
  },
  {
    abbrev: 'BERI',
    fullName: 'Berkeley Existential Risk Initiative',
    existingName: 'Berkeley Existential Risk Initiative (BERI)',
  },
  {
    abbrev: 'FHI',
    fullName: 'Future of Humanity Institute',
    existingName: 'Future of Humanity Institute (closed 2024)',
  },
...
async function findEntityByName(name) {
  const result = await rds.query('SELECT id, name FROM entity WHERE LOWER(name) = LOWER($1)', [name])
