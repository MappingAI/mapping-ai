...
function getRoleGuidance(person) {
  ...
  if (cat.includes('policymaker') || title.match(/senator|congress|assembl|legislat|representative|secretary|commissioner|governor/)) {
    return {
      type: 'Policymaker',
      stanceExample: "Sponsored the RAISE Act, which places safety requirements specifically on frontier AI developers who have spent $100M+ on training. Has explicitly distanced himself from broad restriction, emphasizing the bill is narrowly scoped.",
      threatExample: "The RAISE Act was designed to address severe risks including assisting in the creation of bioweapons and automated criminal activity. Also sponsors training data transparency legislation.",
      notesExample: "Named to Time 100 AI list (2025); won Future Caucus Rising Star award (2024). Running for NY-12 Congressional seat; being targeted by AI industry super PAC. Has MS in Computer Science (Georgia Tech).",
      lookFor: "bills sponsored/co-sponsored, committee assignments, floor statements, testimony, votes, campaign positions, endorsements, PAC opposition/support"
    };
  } else if (cat.includes('executive') || title.match(/ceo|cto|coo|founder|co-founder|chief|president(?! of)/)) {
    return {
      type: 'Executive',
      stanceExample: "Advocates for 'responsible scaling' rather than pausing development. Company voluntarily committed to pre-deployment safety testing and red-teaming. Testified before Senate supporting targeted disclosure requirements but opposing broad licensing.",
      threatExample: "Has publicly warned about concentration of AI power in few hands, potential for autonomous weapons, and risks of rushing capabilities without adequate safety research. Published essay on bioweapon risks.",
      notesExample: "Co-founded Anthropic (2021) after leaving OpenAI over safety disagreements. Published 'Machines of Loving Grace' (Oct 2024). Former VP Research at OpenAI. PhD Physics, Princeton.",
      lookFor: "company safety policies, voluntary commitments, congressional testimony, blog posts/essays, interviews, product decisions, hiring priorities, funding raised"
    };
    ...
    return {
      ...
      stanceExample: "Co-authored influential paper arguing for mandatory third-party audits of frontier models. Testified before Congress recommending compute thresholds for regulation. Has called current voluntary commitments 'insufficient'.",
      threatExample: "Research focuses on AI alignment and interpretability. Has published on deceptive AI systems and instrumental convergence. Warns about recursive self-improvement scenarios.",
      notesExample: "Professor of Computer Science at Stanford; Director of HAI. Previously at Google Brain (2015-2020). Authored 'The Alignment Problem' (2020). Over 50,000 citations.",
      lookFor: "papers published, research focus, expert testimony, policy recommendations, institutional affiliations, citations, awards, grants, media commentary"
    };
  } else if (cat.includes('investor')) {
    return {
      type: 'Investor',
      stanceExample: "Portfolio heavily weighted toward AI safety startups. Has publicly stated will not invest in companies without safety review boards. Advocates for voluntary industry standards over government regulation.",
      threatExample: "Warns about economic disruption from rapid automation. Funds research on AI job displacement. Concerned about concentration of AI capabilities in few large labs.",
      notesExample: "General Partner at Founders Fund. Led Series A investments in Anthropic, Cohere. Previously founded PayPal with Peter Thiel. Forbes Midas List (2023, 2024).",
      lookFor: "portfolio companies, investment thesis, public statements, board seats, fund focus areas, returns, co-investors"
    };
  } else if (cat.includes('journalist') || title.match(/journalist|reporter|editor|columnist|correspondent/)) {
    return {
      type: 'Journalist',
      stanceExample: "Coverage tends to emphasize AI risks and corporate accountability. Has written critically about voluntary safety commitments. Broke story on OpenAI internal safety concerns.",
      threatExample: "Reporting focuses on labor displacement, algorithmic bias, and corporate lobbying against regulation. Has covered AI-generated misinformation extensively.",
      notesExample: "AI reporter at New York Times since 2022. Previously covered tech at Wired. Won Pulitzer Prize for series on facial recognition (2023). Author of 'Code Red' (2024).",
      lookFor: "beat/coverage area, notable stories broken, publications, awards, books authored, expertise areas, social media following"
    };
  } else if (cat.includes('organizer') || title.match(/organizer|activist|advocate|director.*union|campaign/)) {
    return {
      type: 'Organizer/Advocate',
      stanceExample: "Leading campaign for mandatory algorithmic impact assessments. Coalition brought together 50+ civil society groups to oppose industry self-regulation. Advocates for worker voice in AI deployment decisions.",
      threatExample: "Organization focuses on labor rights in the AI era, algorithmic discrimination, and corporate accountability. Has campaigned against specific AI hiring tools.",
      notesExample: "Executive Director of AI Now Institute since 2020. Former FTC advisor (2018-2020). Co-authored 'Discriminating Systems' report. Organizes annual AI accountability summit.",
      lookFor: "organizations led, campaigns organized, coalitions built, policy wins, testimony, reports published, events convened"
    };
    ...
    return {
      ...
      stanceExample: "Has argued AI development should be slowed until governance catches up. Public intellectual voice for precautionary approach. Signed open letter calling for 6-month pause on frontier AI training.",
      threatExample: "Writing emphasizes existential risk and loss of human agency. Warns about AI consciousness and moral status questions. Concerned about 'race to the bottom' on safety.",
      notesExample: "Author of 'Superintelligence' (2014) and 'Deep Utopia' (2024). Professor of Philosophy at Oxford; Director of Future of Humanity Institute. Over 100,000 Twitter followers.",
      lookFor: "books written, major essays, public lectures, open letters signed, media appearances, academic positions, public debates"
    };
  }
  ...
  return {
    type: 'General',
    stanceExample: "Has publicly advocated for [specific policy]. Signed [specific letter/commitment]. Testified/spoke at [specific venue] arguing for [specific approach].",
    threatExample: "Has expressed concern about [specific risks]. Work/statements focus on [specific threat areas].",
    notesExample: "Background in [field]. Previously at [organizations]. Notable for [specific achievements/positions].",
