...
const MISSING_ORGS = [
  ...
  { name: 'U.S. House of Representatives', category: 'Government/Agency', website: 'https://house.gov' },
  { name: 'California State Senate', category: 'Government/Agency', website: 'https://senate.ca.gov' },
  { name: 'New York State Assembly', category: 'Government/Agency', website: 'https://nyassembly.gov' },

  // Government - Executive
  { name: 'White House', category: 'Government/Agency', website: 'https://whitehouse.gov' },
  { name: 'U.S. Department of Commerce', category: 'Government/Agency', website: 'https://commerce.gov' },
  ...
  { name: 'Office of the Governor of Indiana', category: 'Government/Agency', website: 'https://in.gov/gov' },

  // Political Parties
  { name: 'Republican Party', category: 'Political Campaign/PAC', website: 'https://gop.com' },
  { name: 'Democratic Party', category: 'Political Campaign/PAC', website: 'https://democrats.org' },
  ...
  { name: 'MIT Sloan', category: 'Academic', website: 'https://mitsloan.mit.edu', parentName: 'Massachusetts Institute of Technology' },

  // Research / Safety orgs
  { name: 'Center for Humane Technology', category: 'Ethics/Bias/Rights', website: 'https://humanetech.com' },
  ...
  { name: 'Gates Foundation', category: 'VC/Capital/Philanthropy', website: 'https://gatesfoundation.org' },
  { name: 'Emerson Collective', category: 'VC/Capital/Philanthropy', website: 'https://emersoncollective.com' },
  ...
  // Other
  { name: 'Common Sense Media', category: 'Ethics/Bias/Rights', website: 'https://commonsensemedia.org' },
  { name: 'Civic Signals', category: 'Think Tank/Policy Org', website: 'https://civicsignals.io' },
  { name: 'Amazon Labor Union', category: 'Labor/Civil Society', website: 'https://amazonlaborunion.org' },
];

// Aliases: map variations to canonical names
const ALIASES = {
  'U.S. Senate': 'United States Senate',
  'Office of Science and Technology Policy': 'White House Office of Science and Technology Policy (OSTP)',
...
async function main() {
  ...
  try {
    ...
    console.log('SUMMARY');
    console.log('==============================');
    console.log(`Orgs ${dryRun ? 'to create' : 'created'}: ${dryRun ? MISSING_ORGS.filter(o => !existingByName.has(o.name.toLowerCase())).length : created}`);
    console.log(`Still unmatched orgs: ${sortedNeeds.filter(([org]) => !MISSING_ORGS.find(o => o.name.toLowerCase() === org.toLowerCase())).length}`);
