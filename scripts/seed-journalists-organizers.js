...
const JOURNALISTS = [
  // Tier 1: AI Beat Reporters (major outlets)
  {
    name: 'Cade Metz',
    category: 'Journalist',
    title: 'Technology Reporter, The New York Times; Author, Genius Makers',
    primary_org: 'The New York Times',
  },
  {
    name: 'Kevin Roose',
    category: 'Journalist',
    title: 'Technology Columnist, The New York Times; Co-host, Hard Fork Podcast',
    primary_org: 'The New York Times',
  },
  {
    name: 'Will Knight',
    category: 'Journalist',
    title: 'Senior Writer, Wired; AI & Robotics Coverage',
    primary_org: 'Wired',
  },
  {
    name: 'James Vincent',
    category: 'Journalist',
    title: 'Senior Reporter, The Verge; AI & Science Coverage',
    primary_org: 'The Verge',
  },
  {
    name: 'Melissa Heikkilä',
    category: 'Journalist',
    title: 'Senior Reporter, MIT Technology Review; AI Policy & EU Focus',
    primary_org: 'MIT Technology Review',
  },
  {
    name: 'Parmy Olson',
    category: 'Journalist',
    title:
      'Columnist, Bloomberg Opinion; Author, Supremacy: AI, ChatGPT, and the Race That Will Change the World',
    primary_org: 'Bloomberg',
  },
  {
    name: 'Madhumita Murgia',
    category: 'Journalist',
    title: 'AI Editor, Financial Times; Author, Code Dependent',
    primary_org: 'Financial Times',
  },
  {
    name: "Matt O'Brien",
    category: 'Journalist',
    title: 'Technology Writer, Associated Press; AI Policy Coverage',
    primary_org: 'Associated Press',
  },
  {
    name: 'Nitasha Tiku',
    category: 'Journalist',
    title: 'Technology Reporter, The Washington Post; AI Labor & Ethics',
    primary_org: 'The Washington Post',
  },
  {
    name: 'Kara Swisher',
    category: 'Journalist',
    title: 'Host, On with Kara Swisher & Pivot Podcasts; Co-founder, Recode',
    primary_org: 'Vox Media',
  },
  ...
  // Tier 2: Substacks & Independent Voices
  {
    ...
    category: 'Academic',
    title:
      'Associate Professor, Wharton School; Author, One Useful Thing Newsletter & Co-Intelligence',
    primary_org: 'University of Pennsylvania',
  },
  {
    name: 'Leopold Aschenbrenner',
    category: 'Researcher',
    title: 'Founder, Situational Awareness; Former OpenAI Superalignment Researcher',
    primary_org: null,
  },
  {
    name: 'Nathan Lambert',
    category: 'Researcher',
    title: 'Research Scientist; Author, Interconnects Newsletter; RLHF Expert',
    primary_org: null,
  },
  {
    name: 'Zvi Mowshowitz',
    category: 'Researcher',
    title: "AI Policy Analyst; Author, Don't Worry About the Vase",
    primary_org: null,
  },
  ...
  // Tier 3: Podcasters
  {
    name: 'Lex Fridman',
    category: 'Journalist',
    title: 'Host, Lex Fridman Podcast; Research Scientist, MIT',
    primary_org: 'MIT',
  },
  {
    name: 'Dwarkesh Patel',
    category: 'Journalist',
    title: 'Host, Dwarkesh Podcast; AI Researcher Interviews',
    primary_org: null,
  },
  {
    name: 'Craig Smith',
    category: 'Journalist',
    title: 'Host, Eye on AI Podcast',
    primary_org: null,
  },
  {
    name: 'Nathaniel Whittemore',
    category: 'Journalist',
    title: 'Host, The AI Breakdown Podcast',
    primary_org: null,
  },
]
...
const ORGANIZERS = [
  // AI-Specific Advocacy
  {
    name: 'Sneha Revanur',
    category: 'Organizer',
    title: 'Founder & President, Encode Justice; Gen Z AI Policy Advocate',
    primary_org: 'Encode Justice',
  },
  {
    name: 'Mary Wareham',
    category: 'Organizer',
    title:
      'Advocacy Director, Arms Division, Human Rights Watch; Coordinator, Campaign to Stop Killer Robots',
    primary_org: 'Human Rights Watch',
  },
  {
    name: 'Rebecca Finlay',
    category: 'Organizer',
    title: 'CEO, Partnership on AI',
    primary_org: 'Partnership on AI',
  },
  {
    name: 'Mark Surman',
    category: 'Organizer',
    title: 'President & Executive Director, Mozilla Foundation',
  ...
  // Labor & Worker Advocacy
  {
    name: 'Veena Dubal',
    category: 'Academic',
    title: 'Professor of Law, UC Irvine; Gig Economy & Algorithmic Management Expert',
    primary_org: 'UC Irvine',
  },
  {
    name: 'Alex Hanna',
    category: 'Organizer',
    title:
      'Director of Research, Distributed AI Research Institute (DAIR); Former Google AI Ethics',
    primary_org: 'DAIR',
  },
  {
    name: 'Liz Shuler',
    category: 'Organizer',
    title: 'President, AFL-CIO',
    primary_org: 'AFL-CIO',
  },
  ...
  // Tech Worker Organizing
  {
    name: 'Mira Murati',
    category: 'Executive',
    title: 'Former CTO, OpenAI; Founder, Thinking Machines Lab',
    primary_org: 'Thinking Machines Lab',
  },
]
...
const ORGANIZATIONS = [
  ...
  { name: 'Human Rights Watch', category: 'Ethics/Bias/Rights', website: 'https://hrw.org' },
  {
    ...
    website: 'https://stopkillerrobots.org',
  },
  {
  ...
  { name: 'AFL-CIO', category: 'Labor/Civil Society', website: 'https://aflcio.org' },
  {
    ...
    notes: 'Distributed AI Research Institute, founded by Timnit Gebru',
  },
  {
    name: 'Thinking Machines Lab',
    category: 'Frontier Lab',
    website: null,
    notes: 'AI research company founded by Mira Murati',
  },
]
