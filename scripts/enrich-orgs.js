...
function getOrgGuidance(org) {
  ...
  if (cat.includes('frontier lab')) {
    return {
      ...
      threatExample: "Company safety team focuses on alignment research, red-teaming for dangerous capabilities (bio, cyber), and preventing misuse.",
      notesExample: "Founded 2015 as nonprofit, restructured 2019. Launched ChatGPT (Nov 2022), GPT-4 (Mar 2023). 1,500+ employees, valued at $80B+.",
      lookFor: "products/models released, funding raised, valuation, employee count, safety policies, government testimony"
    };
  } else if (cat.includes('safety') || cat.includes('alignment')) {
    return {
      type: 'AI Safety/Alignment Organization',
      stanceExample: "Advocates for mandatory safety evaluations and third-party audits before deploying frontier models.",
    ...
    return {
      ...
      stanceExample: "Publishes policy briefs advocating for risk-based regulatory framework with mandatory incident reporting.",
    ...
    return {
      ...
      stanceExample: "Portfolio includes both AI capabilities and safety companies. Investment thesis emphasizes 'responsible AI'.",
    ...
    return {
      ...
      stanceExample: "Faculty publish research on AI governance frameworks. Lab director testified advocating for mandatory audits.",
