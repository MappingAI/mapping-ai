...
function getOrgGuidance(org) {
  ...
  if (cat.includes('frontier lab')) {
    ...
    return {
      ...
      threatExample:
        'Research focuses on alignment techniques (RLHF, interpretability), deceptive alignment risks.',
    ...
    return {
      ...
      notesExample:
        'Founded 2018, nonprofit. Based in Washington DC. Staff of 15. Funded by Ford Foundation.',
    ...
    return {
      ...
      notesExample:
        'Founded 2015, $500M AUM. 40 portfolio companies. Key AI investments: Anthropic, Cohere.',
    ...
    return {
      ...
      threatExample:
        'Regulatory focus on algorithmic discrimination, AI in critical infrastructure.',
    ...
    return {
      ...
      stanceExample:
        'Advocates for worker voice in AI deployment decisions, algorithmic transparency.',
      threatExample:
        'Campaigns focus on AI-driven surveillance, algorithmic management, gig worker rights.',
