...
const POLICYMAKERS = [
  // Congressional - Senate AI Working Group / Key AI legislators
  {
    ...
    title: 'Senate Majority Leader; Convener, Senate AI Insight Forums',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Mike Rounds',
    category: 'Policymaker',
    title: 'U.S. Senator (R-SD); Senate AI Insight Forum Co-Lead',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Martin Heinrich',
    category: 'Policymaker',
    title: 'U.S. Senator (D-NM); Senate AI Insight Forum Co-Lead',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Todd Young',
    category: 'Policymaker',
    title: 'U.S. Senator (R-IN); Senate AI Insight Forum Co-Lead',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Maria Cantwell',
    category: 'Policymaker',
    title: 'Chair, Senate Commerce Committee; AI Legislation Lead',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Ted Cruz',
    category: 'Policymaker',
    title: 'Ranking Member, Senate Commerce Committee',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Richard Blumenthal',
    category: 'Policymaker',
    title: 'Chair, Senate Judiciary Subcommittee on Privacy & Technology; AI Hearings Lead',
    primary_org: 'U.S. Senate',
  },
  {
    name: 'Josh Hawley',
    category: 'Policymaker',
    title: 'U.S. Senator (R-MO); AI Legislation Sponsor',
    primary_org: 'U.S. Senate',
  },
  ...
  // House
  {
    name: 'Jay Obernolte',
    category: 'Policymaker',
    title: 'U.S. Representative (R-CA); Co-Chair, House AI Caucus; Only PhD in AI in Congress',
    primary_org: 'U.S. House',
  },
  {
    name: 'Don Beyer',
    category: 'Policymaker',
    title: 'U.S. Representative (D-VA); Co-Chair, House AI Caucus',
    primary_org: 'U.S. House',
  },
  {
    name: 'Ted Lieu',
    category: 'Policymaker',
    title: 'U.S. Representative (D-CA); House AI Task Force; Computer Science Background',
    primary_org: 'U.S. House',
  },
  {
    name: 'Anna Eshoo',
    category: 'Policymaker',
    title: 'U.S. Representative (D-CA); Silicon Valley Rep; Tech Legislation',
    primary_org: 'U.S. House',
  },
  {
    name: 'Ro Khanna',
    category: 'Policymaker',
    title: 'U.S. Representative (D-CA); Silicon Valley Rep; Tech Policy Voice',
    primary_org: 'U.S. House',
  },
  {
    name: 'Mike Gallagher',
    category: 'Policymaker',
    title: 'Former Chair, House Select Committee on China; AI & National Security',
    primary_org: 'U.S. House',
  },
  ...
  // State Level - California (most active on AI)
  {
    name: 'Scott Wiener',
    category: 'Policymaker',
    title: 'California State Senator; Author, SB 1047 (AI Safety Bill)',
    primary_org: 'California State Senate',
  },
  {
    name: 'Gavin Newsom',
    category: 'Policymaker',
    title: 'Governor of California; Executive Orders on AI',
    primary_org: 'State of California',
  },
  ...
  // Agency - Additional key figures
  {
    name: 'Bruce Reed',
    category: 'Policymaker',
    title: 'White House Deputy Chief of Staff; AI Policy Coordinator',
    primary_org: 'White House',
  },
]
...
const EXECUTIVES = [
  ...
  },
  {
    ...
    category: 'Executive',
    title: 'CEO, Meta; Open Source AI Advocate',
    primary_org: 'Meta',
  },
  ...
  // AI company leaders
  {
    name: 'Arthur Mensch',
    category: 'Executive',
    title: 'CEO & Co-founder, Mistral AI',
    primary_org: 'Mistral AI',
  },
  {
    name: 'Aravind Srinivas',
    category: 'Executive',
    title: 'CEO & Co-founder, Perplexity AI',
    primary_org: 'Perplexity AI',
  },
  {
    name: 'Noam Shazeer',
    category: 'Executive',
    title: 'CEO, Character.AI; Former Google Transformer Co-author',
    primary_org: 'Character.AI',
  },
  {
    name: 'Emad Mostaque',
    category: 'Executive',
    title: 'Former CEO, Stability AI; Open Source AI Advocate',
    primary_org: null,
  },
  {
    name: 'Richard Socher',
    category: 'Executive',
    title: 'CEO, You.com; Former Salesforce Chief Scientist',
    primary_org: 'You.com',
  },
]
...
const ORGANIZERS_LABOR = [
  // Labor unions with AI focus
  {
    name: 'Sara Nelson',
    category: 'Organizer',
    title: 'International President, Association of Flight Attendants-CWA; Labor Leader',
    primary_org: 'AFA-CWA',
  },
  {
    name: 'Chris Smalls',
    category: 'Organizer',
    title: 'President, Amazon Labor Union; Warehouse Worker AI/Automation Advocacy',
    primary_org: 'Amazon Labor Union',
  },
  {
    name: 'Fran Drescher',
    category: 'Organizer',
    title: 'President, SAG-AFTRA; Led 2023 Strike on AI Likeness Rights',
    primary_org: 'SAG-AFTRA',
  },
  {
    name: 'Meredith Stiehm',
    category: 'Organizer',
    title: 'President, Writers Guild of America West; AI Contract Negotiations',
    primary_org: 'WGA West',
  },

  // Tech worker advocacy
  {
    name: 'Chelsey Glasson',
    category: 'Organizer',
    title: 'Founder, Tech Workers Coalition; Google Walkout Organizer',
    primary_org: 'Tech Workers Coalition',
  },
]
...
const INVESTORS_TIER2 = [
  // Policy-connected investors not yet added
  {
    ...
    category: 'Investor',
    title: 'Founder, Emerson Collective; Philanthropist; AI & Media Investments',
    primary_org: 'Emerson Collective',
  },
  {
    name: 'Chris Sacca',
    category: 'Investor',
    title: 'Founder, Lowercase Capital; Early Twitter/Uber Investor; Climate & AI',
    primary_org: 'Lowercase Capital',
  },
  {
    name: 'Naval Ravikant',
    category: 'Investor',
    title: 'Co-founder, AngelList; Philosopher-Investor; AI Commentary',
    primary_org: 'AngelList',
  },
  {
    name: 'Balaji Srinivasan',
    category: 'Investor',
    title: 'Former CTO, Coinbase; Former a16z GP; AI & Crypto Commentator',
    primary_org: null,
  },
  ...
  // Defense/National Security AI investors
  {
    name: 'Palmer Luckey',
    category: 'Executive',
    title: 'Founder, Anduril Industries & Oculus; Defense AI',
    primary_org: 'Anduril',
  },
  {
    name: 'Trae Stephens',
    category: 'Investor',
    title: 'Co-founder, Anduril; Partner, Founders Fund; Former Palantir',
    primary_org: 'Founders Fund',
  },
]
...
const CULTURAL_TIER2 = [
  // Authors and public voices
  {
    ...
    title: 'Biographer; Author, Elon Musk; Former CNN CEO',
    primary_org: null,
  },
  {
    name: 'Steven Levy',
    category: 'Journalist',
    title: 'Editor at Large, Wired; Author, Hackers; Tech Journalism Pioneer',
    primary_org: 'Wired',
  },
  {
    name: 'Kevin Kelly',
    category: 'Cultural figure',
    title: 'Founding Editor, Wired; Author, The Inevitable; Tech Futurist',
    primary_org: 'Wired',
  },
  {
    name: 'Tristan Harris',
    category: 'Organizer',
    title: 'Co-founder, Center for Humane Technology; The Social Dilemma',
    primary_org: 'Center for Humane Technology',
  },
  {
    name: 'Aza Raskin',
    category: 'Organizer',
    title: 'Co-founder, Center for Humane Technology; Earth Species Project',
    primary_org: 'Center for Humane Technology',
  },
]
...
const ORGANIZATIONS = [
  ...
  // Companies
  {
    ...
    notes: 'GPU leader, AI infrastructure',
  },
  {
    name: 'AMD',
    category: 'Frontier Lab',
    website: 'https://amd.com',
    notes: 'GPU/chip competitor',
  },
  {
    name: 'Perplexity AI',
    category: 'Frontier Lab',
    website: 'https://perplexity.ai',
    notes: 'AI search startup',
  },
  {
    name: 'Character.AI',
    category: 'Frontier Lab',
    website: 'https://character.ai',
    notes: 'Conversational AI',
  },
  { name: 'You.com', category: 'Frontier Lab', website: 'https://you.com', notes: 'AI search' },
  {
    ...
    notes: 'Defense AI, Palmer Luckey',
  },
  ...
  // Labor
  {
    ...
    website: 'https://afacwa.org',
    notes: 'Association of Flight Attendants',
  },
  {
    name: 'Amazon Labor Union',
    category: 'Labor/Civil Society',
    website: null,
    notes: 'Chris Smalls, warehouse workers',
  },
  {
    name: 'SAG-AFTRA',
    category: 'Labor/Civil Society',
    website: 'https://sagaftra.org',
    notes: 'Actors union, AI likeness rights',
  },
  {
    name: 'WGA West',
    category: 'Labor/Civil Society',
    website: 'https://wga.org',
    notes: 'Writers Guild, AI contract terms',
  },
  {
