...
const PACS = [
  ...
  },
  {
    ...
    category: 'Political Campaign/PAC',
    stance: 'pro-innovation',
    notes: 'Spent ~$2.42M opposing Alex Bores in NY-HD-12. Also supported Jesse Jackson Jr. (IL-HD-02) and Melissa Bean (IL-HD-08).',
  },
  {
    ...
    category: 'Political Campaign/PAC',
    stance: 'pro-innovation',
    notes: 'Supported candidates in TX and NC races. Backed Chris Gober, Tom Sell, Jessica Steinmann, Laurie Buckhout, Clay Fuller, Jace Yarbrough.',
  },
  {
  ...
  },
  {
    ...
    category: 'Political Campaign/PAC',
    stance: 'pro-safety',
    notes: 'Major supporter of Alex Bores (~$468K) and Valerie Foushee (~$1.6M). Also supported Colin Allred.',
  },
  {
    name: 'Dream NYC',
    fecId: 'C00928069',
...
const CANDIDATES = [
  { name: 'Alex Bores', race: 'NY House District 12', location: 'New York, NY', totalSpent: '$3.02M', aiContext: 'NY state assemblyman running for Congress, subject of heavy AI PAC spending both for and against. Opposed by Think Big (~$2.42M), supported by Jobs and Democracy PAC and Dream NYC.' },
  { name: 'Valerie Foushee', race: 'NC House District 04', location: 'North Carolina', totalSpent: '$1.62M', aiContext: 'Backed candidate won. Supported by Jobs and Democracy PAC (pro-safety).' },
  { name: 'Jesse Jackson Jr.', race: 'IL House District 02', location: 'Illinois', totalSpent: '$1.40M', aiContext: 'Backed candidate lost. Supported by Think Big (pro-innovation).' },
  { name: 'Melissa Bean', race: 'IL House District 08', location: 'Illinois', totalSpent: '$1.12M', aiContext: 'Backed candidate won. Supported by Think Big (pro-innovation).' },
  { name: 'Chris Gober', race: 'TX House District 10', location: 'Texas', totalSpent: '$747,550', aiContext: 'Backed candidate won. Supported by American Mission (pro-innovation).' },
  { name: 'Tom Sell', race: 'TX House District 19', location: 'Texas', totalSpent: '$578,986', aiContext: 'Runoff. Supported by American Mission (pro-innovation).' },
  { name: 'Jessica Steinmann', race: 'TX House District 08', location: 'Texas', totalSpent: '$511,025', aiContext: 'Backed candidate won. Supported by American Mission (pro-innovation).' },
  { name: 'Laurie Buckhout', race: 'NC House District 01', location: 'North Carolina', totalSpent: '$509,067', aiContext: 'Backed candidate won. Supported by American Mission (pro-innovation).' },
  { name: 'Clay Fuller', race: 'GA House District 14', location: 'Georgia', totalSpent: '$436,580', aiContext: 'Supported by American Mission (pro-innovation).' },
  { name: 'Colin Allred', race: 'TX House District 33', location: 'Texas', totalSpent: '$149,926', aiContext: 'Supported by Jobs and Democracy PAC (pro-safety).' },
  { name: 'Pete Ricketts', race: 'NE Senate', location: 'Nebraska', totalSpent: '$250,765', aiContext: 'Supported by Defending Our Values PAC (pro-safety).' },
  { name: 'Jace Yarbrough', race: 'TX House District 32', location: 'Texas', totalSpent: '$129,367', aiContext: 'Supported by American Mission (pro-innovation).' },
  { name: 'Alexandra Mealer', race: 'TX House District 09', location: 'Texas', totalSpent: '$223,736', aiContext: 'Supported by Defending Our Values PAC (pro-safety).' },
  { name: 'Carlos De La Cruz', race: 'TX House District 35', location: 'Texas', totalSpent: '$479,731', aiContext: 'Supported by Defending Our Values PAC (pro-safety).' },
];
...
const PAC_CANDIDATE_EDGES = [
  ...
  { pac: 'Think Big', candidate: 'Alex Bores', action: 'opposing', amount: '$2.42M', edgeType: 'critic', role: 'Opposed by Think Big PAC ($2.42M spent against)' },
  { pac: 'Think Big', candidate: 'Jesse Jackson Jr.', action: 'supporting', amount: '$1.40M', edgeType: 'funder', role: 'Supported by Think Big PAC ($1.40M spent for)' },
  { pac: 'Think Big', candidate: 'Melissa Bean', action: 'supporting', amount: '$1.12M', edgeType: 'funder', role: 'Supported by Think Big PAC ($1.12M spent for)' },
  // American Mission (pro-innovation)
  { pac: 'American Mission', candidate: 'Chris Gober', action: 'supporting', amount: '$747K', edgeType: 'funder', role: 'Supported by American Mission PAC ($747K spent for)' },
  { pac: 'American Mission', candidate: 'Tom Sell', action: 'supporting', amount: '$579K', edgeType: 'funder', role: 'Supported by American Mission PAC ($579K spent for)' },
  { pac: 'American Mission', candidate: 'Jessica Steinmann', action: 'supporting', amount: '$511K', edgeType: 'funder', role: 'Supported by American Mission PAC ($511K spent for)' },
  { pac: 'American Mission', candidate: 'Laurie Buckhout', action: 'supporting', amount: '$509K', edgeType: 'funder', role: 'Supported by American Mission PAC ($509K spent for)' },
  { pac: 'American Mission', candidate: 'Clay Fuller', action: 'supporting', amount: '$437K', edgeType: 'funder', role: 'Supported by American Mission PAC ($437K spent for)' },
  { pac: 'American Mission', candidate: 'Jace Yarbrough', action: 'supporting', amount: '$129K', edgeType: 'funder', role: 'Supported by American Mission PAC ($129K spent for)' },
  // Jobs and Democracy PAC (pro-safety)
  { pac: 'Jobs and Democracy PAC', candidate: 'Alex Bores', action: 'supporting', amount: '$468K', edgeType: 'funder', role: 'Supported by Jobs and Democracy PAC ($468K spent for)' },
  { pac: 'Jobs and Democracy PAC', candidate: 'Valerie Foushee', action: 'supporting', amount: '$1.61M', edgeType: 'funder', role: 'Supported by Jobs and Democracy PAC ($1.61M spent for)' },
  { pac: 'Jobs and Democracy PAC', candidate: 'Colin Allred', action: 'supporting', amount: '$150K', edgeType: 'funder', role: 'Supported by Jobs and Democracy PAC ($150K spent for)' },
  // Defending Our Values PAC (pro-safety)
  { pac: 'Defending Our Values PAC', candidate: 'Alexandra Mealer', action: 'supporting', amount: '$224K', edgeType: 'funder', role: 'Supported by Defending Our Values PAC ($224K spent for)' },
  { pac: 'Defending Our Values PAC', candidate: 'Carlos De La Cruz', action: 'supporting', amount: '$480K', edgeType: 'funder', role: 'Supported by Defending Our Values PAC ($480K spent for)' },
  { pac: 'Defending Our Values PAC', candidate: 'Pete Ricketts', action: 'supporting', amount: '$251K', edgeType: 'funder', role: 'Supported by Defending Our Values PAC ($251K spent for)' },
  // Dream NYC (pro-safety)
  { pac: 'Dream NYC', candidate: 'Alex Bores', action: 'supporting', amount: '$1.3K', edgeType: 'funder', role: 'Supported by Dream NYC PAC ($1.3K spent for)' },
];

// Also mentioned in articles
const EXTRA_PEOPLE = [
  { name: 'Chris Lehane', title: 'VP of Global Affairs', primaryOrg: 'OpenAI', category: 'Executive', aiContext: 'OpenAI political strategist described as "guerrilla warrior" / "master of disaster". Key figure connecting AI industry to political campaigns.' },
];
...
async function enrichPerson(exa, person) {
  ...
  const query = `${person.name} ${person.race || ''} politician AI policy artificial intelligence 2025 2026`.trim();
  ...
  try {
    ...
    let socialResult;
    try {
      socialResult = await exa.search(`${person.name} politician official website twitter bluesky`, {
        type: 'auto',
        numResults: 3,
        contents: {
          summary: {
    ...
    return {
      ...
      sources: [],
      socialSummaries: [],
      website: null, twitter: null, bluesky: null, primaryOrg: null,
      regulatoryStance: null, regulatoryStanceDetail: null,
      agiTimeline: null, aiRiskLevel: null, evidenceSource: null,
      threatModels: null, notes: null,
      error: err.message,
    };
  }
}
...
async function enrichExtraPerson(exa, person) {
  ...
  try {
    ...
    return {
      ...
      highlights: highlights.slice(0, 10),
      sources: urls,
      website: null, twitter: null, bluesky: null,
      regulatoryStance: null, regulatoryStanceDetail: null,
      agiTimeline: null, aiRiskLevel: null, evidenceSource: null,
      threatModels: null, notes: null,
    };
    ...
    console.warn(`    ⚠ Exa search failed for ${person.name}: ${err.message}`);
    return {
      entityType: 'person', name: person.name, category: person.category || 'Executive',
      title: person.title || null, primaryOrg: person.primaryOrg || null,
      aiContext: person.aiContext, summaries: [], highlights: [], sources: [],
      website: null, twitter: null, bluesky: null,
      regulatoryStance: null, regulatoryStanceDetail: null,
      agiTimeline: null, aiRiskLevel: null, evidenceSource: null,
      threatModels: null, notes: null, error: err.message,
    };
  }
}
...
async function enrichPAC(exa, pac) {
  ...
  try {
    ...
    return {
      entityType: 'organization', name: pac.name, category: pac.category,
      fecId: pac.fecId, stance: pac.stance,
      summaries: [], highlights: [], sources: [],
      website: null, twitter: null, bluesky: null, fundingModel: null,
      regulatoryStance: pac.stance === 'pro-innovation' ? 'Light-touch' : 'Targeted',
      regulatoryStanceDetail: null, notes: pac.notes || null, error: err.message,
    };
  }
}
...
async function fetchAndEnrich() {
  ...
  const results = { people: [], organizations: [], meta: { fetchedAt: new Date().toISOString(), source: 'elections.transformernews.ai' } };
  ...
  console.log('  2. Fill in missing fields (website, twitter, bluesky, beliefs) using the summaries as reference');
  console.log('  3. Run: node scripts/enrich-elections.js --review    (to see a summary)');
  console.log('  4. Run: node scripts/enrich-elections.js --insert    (to add as pending submissions)');
}
...
async function review() {
  ...
  for (const org of data.organizations) {
    ...
    console.log(`  ${status} ${org.name} [${org.category}] stance=${org.regulatoryStance || '?'} website=${org.website || '?'} twitter=${org.twitter || '?'}`);
  ...
  for (const p of data.people) {
    ...
    console.log(`  ${status} ${p.name} [${p.category}] title=${p.title || '?'} loc=${p.location || '?'} stance=${p.regulatoryStance || '?'}`);
  ...
  try {
    ...
    for (const entity of allEntities) {
      ...
      if (asApproved) {
        ...
        console.log(`  ✓ INSERTED entity #${result.rows[0].id}: ${entity.name} [${entity.entityType}]`);
      } else {
        ...
        console.log(`  ✓ SUBMITTED #${result.rows[0].id}: ${entity.name} [${entity.entityType}] (pending)`);
      }
      inserted++;
    }
...
function buildNotes(entity) {
  ...
  if (entity.entityType === 'person' && entity.race) {
    ...
    htmlParts.push(`<p>${raceLine} See <a href="${TRACKER_URL}">Transformer AI Election Tracker</a> for live spending data.</p>`);
  ...
  if (entity.entityType === 'organization' && entity.fecId) {
    ...
    const stanceLine = entity.stance === 'pro-innovation'
    ...
    htmlParts.push(`<p>${combined} See <a href="${TRACKER_URL}">Transformer AI Election Tracker</a> for live spending data.</p>`);
    ...
    for (const rel of PAC_CANDIDATE_EDGES) {
      ...
      try {
        await client.query(
          ...
          [sourceId, targetId, rel.edgeType, rel.role,
           `${rel.action} (${rel.amount}) — source: elections.transformernews.ai`]
        );
        console.log(`  ✓ ${rel.pac} —[${rel.edgeType}]→ ${rel.candidate} (${rel.action}, ${rel.amount})`);
        created++;
      } catch (err) {
...
if (args.includes('--review')) {
  ...
  insertIntoDB(true).catch(err => { console.error(err); process.exit(1); });
} else if (args.includes('--insert')) {
  insertIntoDB(false).catch(err => { console.error(err); process.exit(1); });
} else if (args.includes('--edges')) {
  createEdges().catch(err => { console.error(err); process.exit(1); });
} else {
  fetchAndEnrich().catch(err => { console.error(err); process.exit(1); });
}
